...
document.addEventListener("DOMContentLoaded", function() {
    const cityDetailsLink = document.querySelector("#current-weather a");

    cityDetailsLink.addEventListener("click", function(event) {
        event.preventDefault();

        // Get the city name and other city details from your current page
        const cityName = document.querySelector("#current-city").textContent;
        ...
        const uvIndex = document.querySelector("#uv-index").textContent;

        // Construct the URL for the "Details.html" page with query parameters
        const detailsURL = `Details.html?cityName=${cityName}&temperature=${temperature}&humidity=${humidity}&windSpeed=${windSpeed}&uvIndex=${uvIndex}`;

        // Redirect to the "Details.html" page with the city details
